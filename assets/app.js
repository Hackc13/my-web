...
function render() {
  ...
  if (activeType === "software") {
    const matches = "li editor lifeinvader editor".includes(term);
    grid.innerHTML = matches ? `
      <a class="software-launch-card" href="software/lifeinvader/index.html" aria-label="Open LI Editor">
        <div class="software-launch-icon">LI</div>
        <div class="software-launch-info">
          <span class="software-launch-badge">SOFTWARE</span>
          <h3>LI Editor</h3>
          <p>LifeInvader advertisement editor and policy checker.</p>
          <span class="software-launch-open">Open Editor →</span>
        </div>
      </a>
    ` : `<div class="empty">No software found.</div>`;
    bindCards();
    return;
  }
